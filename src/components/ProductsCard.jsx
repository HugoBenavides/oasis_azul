...
const ProductsCard = ({bg,alt,text,link}) => {
  return (
    <div className="relative w-full h-full object-cover group overflow-hidden">
      <img className="rounded-md w-full h-full transition-transform group-hover:scale-110 duration-200 " src={bg} alt={alt} />
